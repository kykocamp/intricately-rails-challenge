...
ActiveRecord::Schema.define(version: 2022_01_16_033055) do
  ...
  create_table "hostnames", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["dns_record_id", "hostname"], name: "index_hostnames_on_dns_record_id_and_hostname", unique: true
    t.index ["dns_record_id"], name: "index_hostnames_on_dns_record_id"
    t.index ["hostname"], name: "index_hostnames_on_hostname"
  end

  add_foreign_key "hostnames", "dns_records", on_delete: :cascade
end
